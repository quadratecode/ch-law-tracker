...
(Art. 9*a* para. 1 lets e and f and 12 para. 2)
...
|    a. when based on a molecular-biological analysis for Sars-CoV-2: from the eleventh to the 280th day after confirmation of infection;  
...
|    c. when based on an analysis for Sars-CoV-2 antibodies: for the term of validity of the certificate concerned (Art. 34*a* para. 1 let. c of the COVID-19 Ordinance on Certificates of 4 June 2021).
